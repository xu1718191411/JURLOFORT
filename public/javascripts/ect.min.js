...
(function () {
    ...
    var ECT = function (options) {
        ...
        this.options = {open: "<%", close: "%>", ext: "", cache: true, watch: false, root: ""};
        var ect = this, trimExp = /^[ \t]+|[ \t]+$/g, newlineExp = /\n/g, cache = {}, watchers = {}, indentChars = {
            ":": ":",
            ">": ">"
        }, escapeExp = /[&<>"]/, escapeAmpExp = /&/g, escapeLtExp = /</g, escapeGtExp = />/g, escapeQuotExp = /"/g, regExpEscape = function (str) {
            ...
            var lineNo = 1, bufferStack = ["__ectOutput"], bufferStackPointer = 0, buffer = bufferStack[bufferStackPointer] + " = '", matches = template.split(new RegExp(regExpEscape(ect.options.open) + "((?:.|[\r\n])+?)(?:" + regExpEscape(ect.options.close) + "|$)")), output, text, command, line, prefix, postfix, newline, indentChar, indentation = "", indent = false, indentStack = [], indentStackPointer = -1, baseIndent, lines, j;
    ...
    if (typeof module !== "undefined" && module.exports) {
        ...
        fs = function () {
            ...
            return {readFileSync: readFileSync, watch: watch}
        }()
    }
})();
